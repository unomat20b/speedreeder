...
- Скорость (слов/мин), размер и **цвет слова** (пресеты с образцом), **опорная буква ORP** (как в Spritz), тема приложения.
- При разборе текста **знаки препинания с краёв слов** убираются; слова показываются без «лишней» пунктуации на экране.
